...
namespace MVC_Assignment1.Models
{
    ...
    public partial class NorthwindEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<Cust_Germany_Result> Cust_Germany()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Cust_Germany_Result>("Cust_Germany");
        }
